...
export function CompletePayment() {
  ...
  useEffect(() => {
    ...
    ); // está indo ao location e pagando esse paramentro q passei por queryparams no checkoutform
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      if (!paymentIntent) {
        // vai ao stripe, confirma as informações e trás o status e o id do pagamento
        return;
      }
    ...
    <div className="container">
      <div id="payment-status">
        ...
        <a id="retry-button" href={STATUS_CONTENT_MAP[status].url}>
          {STATUS_CONTENT_MAP[status].buttoText}
        </a>
      </div>
    </div>
  );
